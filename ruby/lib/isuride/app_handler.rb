  ...
  class AppHandler < BaseHandler
    ...
    post '/rides' do
      ...
      fare = db_transaction do |tx|
        ...
        tx.xquery('INSERT INTO ride_statuses (id, ride_id, status) VALUES (?, ?, ?)', generate_id, ride_id, 'MATCHING')
    ...
    post '/rides/:ride_id/evaluation' do
      ...
      response = db_transaction do |tx|
        ...
        tx.xquery('INSERT INTO ride_statuses (id, ride_id, status) VALUES (?, ?, ?)', generate_id, ride_id, 'COMPLETED')
